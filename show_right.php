<div class="right_box">
			...
			<div class="right_small">
				...
				<div class="tuijian">
					<ul>
			<?
			$sql_search="select id,title from lei_news where pass='1' order by rand() limit 10 ";
			...
			<div class="right_small">
				...
				<div class="tuijian">
					<ul>
			<?
			$sql_search="select id,title from lei_jingyan where pass='1' order by rand() limit 10 ";
			$result=$mysqli->query($sql_search);
			while ($rs=$result->fetch_assoc()){
			?>
