<li>
					<label>代码标题：</label><input name="title_search" type="text" class="input length_3" id="title_search" value="<?=$title_search?>">
				</li>
				
				<li>
					<label>代码ID：</label><input name="id_search" type="text" class="input length_3" id="id_search" value="<?=$id_search?>">
				</li>
				
				<li>
					<label>代码分组：</label><select name="keyword_search" id="keyword_search" class="select_3">
						<option value="" <? if ($keyword_search==''){?>selected="selected"<? }?>>--请选择--</option>
						<?
						...
						?>	
							<option value="<?=$rs2["id"]?>" <? if ($rs2["id"]==$keyword_search){?>selected="selected"<? }?>><?=$rs2["keyword"]?></option>	
						<? 
						}?>
					  </select>
				</li>
			...
			<option value="0" <? if ($jingdu_search=='0' || $jingdu_search==''){?>selected="selected"<? }?> >标题查询</option>
			<option value="1" <? if ($jingdu_search=='1'){?>selected="selected"<? }?> >内容查询</option>
          </select>
				</li>
