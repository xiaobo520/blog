...
(function () {
    ...
    window.UEDITOR_CONFIG = {
        ...
        , toolbars: [[
					  'fullscreen','source', 'pasteplain','bold', 'forecolor','italic', 'underline', 'fontborder', 'strikethrough', 'superscript', 'subscript', 'removeformat', 'formatmatch', 'autotypeset', '|', 'backcolor',
