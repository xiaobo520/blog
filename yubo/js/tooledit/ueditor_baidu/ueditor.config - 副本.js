...
(function () {
    ...
    window.UEDITOR_CONFIG = {
        ...
        , toolbars: [[
            'fullscreen',/* 'source', '|',*/ 'undo', 'redo', '|', 'pasteplain','removeformat',
            'bold', 'forecolor',/* 'italic', 'underline', 'fontborder', 'strikethrough', 'superscript', 'subscript', 'removeformat', 'formatmatch', 'autotypeset',  'pasteplain', '|', 'backcolor',*/
            ...
            /*'print',*/ 'preview','insertcode', 'searchreplace', 'drafts'
        ]]
