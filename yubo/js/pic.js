...
function show(event,_this,mess) {
	...
	//var t1="<table     cellspacing='1' cellpadding='10' style='border-color:#CCCCCC;background-color:#FFFFFF;font-size:12px;border-style:solid;    border-width:thin;text-align:center;'><tr><td><img src='" + _this   + "' width='180' height='130' >    <br>"+mess+"</td></tr></table>";
	var t1="<table     cellspacing='1' cellpadding='10' ><tr><td><img src='" + _this   + "' width='180' height='130' ></td></tr></table>";
