...
if ($action=="add"){
	...
	alert_ini();//输出alert所需文件
	echo "<script>alert_go('文章添加成功！','alert_go','','ok','jingyan_list.php?".$back_url."');</script>";
	exit;
...
<div class="wrap">	
	...
	<div class="table_full">
		<table width="100%" >
		    ...
		    <tr>
		      <th>是否视频</th>
		      <td> <input name="shipin" type="text" id="shipin" value="" class="input length_5" />&nbsp;&nbsp;<input name="shipin_button" type="button" value=" 填写时间格式 " onclick="document.getElementById('shipin').value='1小时10分10秒'" /> <input name="shipin_button" type="button" value=" 清空 " onclick="document.getElementById('shipin').value=''" /></td>
	      </tr>
	      <tr>
			  <th>文章来源</th>
			  <td>
		  ...
		  <tr>
			...
			<tr>
			  ...
			  <td>
				...
				<input type="radio" name="zhiding" value="1"  /> 置顶			  </td>
		  </tr>
		  <tr>
			  <th>是否评论</th>
			  <td>
